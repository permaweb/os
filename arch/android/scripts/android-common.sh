...
HANDEE_DEVICE_OVERLAY_ROOT="${HANDEE_DEVICE_OVERLAY_ROOT:-$PERMAWEBOS_ROOT/devices/android}"
HANDEE_DEVICE_ROOT="${HANDEE_DEVICE_ROOT:-$BUILD_DIR/android-devices}"
...
export PERMAWEBOS_ROOT BUILD_DIR PERMAWEBOS_COMMON_DEVICE_ROOT \
    HANDEE_DEVICE_OVERLAY_ROOT HANDEE_DEVICE_ROOT HANDEE_CONFIG \
    HANDEE_RUNTIME_SRC HANDEE_VERIFIER_DIR ANDROID_HOME ANDROID_SDK_ROOT \
    JAVA_HOME PATH
