...
anti-replay must be cryptographic, \texttt{\~{}tpm2@2.0a} exposes
...
\paragraph{Implementation.} The architecture ships in
\texttt{permaweb/HyperBEAM} under \texttt{lapee-baremetal/}. A
...
\texttt{\~{}tpm2@2.0a} device wraps tpm2-tss~\cite{tpm2-tss} for
...
PK/KEK/db via \texttt{sbctl}; \texttt{make hb-usb-write}; boot the
...
envelope returned at \texttt{/\~{}tpm2@2.0a/attestation} is 105 KB
...
\texttt{\~{}tpm2@2.0a} device ship at
\texttt{github.com/permaweb/HyperBEAM} under \texttt{lapee-baremetal/};
